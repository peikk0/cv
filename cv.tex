...
\hypersetup{
    ...
    pdftitle={Pierre Guinoiseau -- Systems engineer / DevOps engineer}
}

\header{Pierre}{Guinoiseau}{Systems engineer / DevOps engineer} % Your name and current job title/field
